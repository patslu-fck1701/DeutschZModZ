...
# DeutschZ System Manager v0.3.7 SHORTCUT-BUGREPORT-FIX
...
$allReportFiles = @(
    ...
    $SafetyDocsLogFile,$WorkDriveNotesFile,$LMStudioPolicyFile,$ShortcutLogFile,$BugReportLogFile,$NextFile
)
...
function Invoke-DZSMSelfCleanup {
    "DeutschZ System Manager v0.3.7 - Selbstbereinigung alter Versionen" | Out-File -FilePath $SelfCleanupFile -Encoding UTF8
    ...
    "v0.3.7 Fix: Erfasst jetzt auch alte BAT/PS1/README/Config/ZIP-Dateien im Arbeitsordner." | Out-File -FilePath $SelfCleanupFile -Append -Encoding UTF8
    ...
    $currentBatName = "Start_DZSM_v0_3_7_SHORTCUT_BUGREPORT_FIX.bat"
    $currentPs1Name = "DZSM_v0_3_7_Shortcut_BugReport_Fix.ps1"
    $currentKeepNames = @(
        $currentBatName,
        $currentPs1Name,
        "README_START.txt",
...
function Write-DZSMStandardStructureReport {
    "DeutschZ System Manager v0.3.7 - Standardstruktur" | Out-File -FilePath $StructureFile -Encoding UTF8
...
Datum: $(Get-Date)
Aktuelle Version: v0.3.7 SHORTCUT-BUGREPORT-FIX
Startdatei: Start_DZSM_v0_3_7_SHORTCUT_BUGREPORT_FIX.bat
...
function Write-DZSMPDriveWorkDriveNotes {
    "DeutschZ System Manager v0.3.7 - P-Root / DayZ Tools WorkDrive Notes" | Out-File -FilePath $WorkDriveNotesFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.7:" | Out-File -FilePath $WorkDriveNotesFile -Append -Encoding UTF8
...
function Invoke-DZSMAutoBackup {
    "DeutschZ System Manager v0.3.7 - SAFE AUTO BACKUP" | Out-File -FilePath $AutoBackupLogFile -Encoding UTF8
...
function Invoke-DZSMGitHubExport {
    "DeutschZ System Manager v0.3.7 - GitHub Export" | Out-File -FilePath $GitHubExportLogFile -Encoding UTF8
...
function Write-DZSMGitHubSafetyDocuments {
    "DeutschZ System Manager v0.3.7 - GitHub Safety Documentation" | Out-File -FilePath $SafetyDocsLogFile -Encoding UTF8
...
Start_DZSM_v0_3_7_SHORTCUT_BUGREPORT_FIX.bat
...
function Write-DZSMLMStudioPolicy {
    "DeutschZ System Manager v0.3.7 - LM Studio / Modell Policy" | Out-File -FilePath $LMStudioPolicyFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.7:" | Out-File -FilePath $LMStudioPolicyFile -Append -Encoding UTF8
...
function Update-DZSMDesktopShortcuts {
    ...
    "DeutschZ System Manager v0.3.7 - Desktop-Verknuepfungen" | Out-File -FilePath $ShortcutLogFile -Encoding UTF8
    ...
    $currentBat = Join-Path $PSScriptRoot "Start_DZSM_v0_3_7_SHORTCUT_BUGREPORT_FIX.bat"
    $currentPs1 = Join-Path $PSScriptRoot "DZSM_v0_3_7_Shortcut_BugReport_Fix.ps1"

    # Nur diese von DZSM automatisch erzeugten Linknamen duerfen entfernt/ersetzt werden.
    # KEIN Wildcard-Loeschen mehr.
    ...
    # Schutz-Hinweis fuer benutzerdefinierte Verknuepfung
...
function Update-DZSMBugReportWorkspace {
    "DeutschZ System Manager v0.3.7 - BugReport Arbeitsordner" | Out-File -FilePath $BugReportLogFile -Encoding UTF8
...
|---|---|---|---|---|---|
| $(Get-Date -Format "yyyy-MM-dd") | v0.3.7 | Desktop-Verknuepfung wurde zu breit geloescht | Wildcard-Loeschregel fuer DZSM-Links war zu aggressiv | Nur exakt bekannte Auto-Linknamen ersetzen; benutzerdefinierte Links schuetzen | behoben |
...
Datum: $(Get-Date)
Version: v0.3.7 SHORTCUT-BUGREPORT-FIX
PC: $env:COMPUTERNAME
Benutzer: $env:USERNAME
...
# START
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.7 - DayZ Tools / P-Drive Mount Log" | Out-File -FilePath $MountLogFile -Encoding UTF8
...
# HAUPTREPORT
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.7 SHORTCUT-BUGREPORT-FIX - Inventurbericht" | Out-File -FilePath $ReportFile -Encoding UTF8
...
# Backup Plan
"DeutschZ System Manager v0.3.7 - Backup Plan" | Out-File -FilePath $BackupPlanFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.7 - DeutschZ Structure Check" | Out-File -FilePath $DeutschZFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.7 - Cleanup Risk Check FAST" | Out-File -FilePath $CleanupFile -Encoding UTF8
...
# Migration check
"DeutschZ System Manager v0.3.7 - Windows SSD Migration Check" | Out-File -FilePath $MigrationFile -Encoding UTF8
...
5. 22_P_ROOT_WORKDRIVE_NOTES.txt`r`n6. 23_LMSTUDIO_MODEL_POLICY.txt`r`n7. 24_DESKTOP_SHORTCUTS_LOG.txt`r`n8. 25_BUGREPORT_WORKSPACE_LOG.txt
6. 11_DEUTSCHZ_STRUCTURE_CHECK.txt
"@ | Out-File -FilePath $NextFile -Encoding UTF8

Write-Section "ERGEBNIS"
"v0.3.7 fertig." | Out-File -FilePath $ReportFile -Append -Encoding UTF8

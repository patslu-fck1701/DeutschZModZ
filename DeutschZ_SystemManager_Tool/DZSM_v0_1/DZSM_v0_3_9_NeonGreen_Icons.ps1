...
# DeutschZ System Manager v0.3.9 NEONGREEN-ICONS
...
function Invoke-DZSMSelfCleanup {
    "DeutschZ System Manager v0.3.9 - Selbstbereinigung alter Versionen" | Out-File -FilePath $SelfCleanupFile -Encoding UTF8
    ...
    "v0.3.9 Fix: Erfasst jetzt auch alte BAT/PS1/README/Config/ZIP-Dateien im Arbeitsordner." | Out-File -FilePath $SelfCleanupFile -Append -Encoding UTF8
    ...
    $currentBatName = "Start_DZSM_v0_3_9_NEONGREEN_ICONS.bat"
    $currentPs1Name = "DZSM_v0_3_9_NeonGreen_Icons.ps1"
    $currentKeepNames = @(
        $currentBatName,
        $currentPs1Name,
        "README_START.txt",
...
function Write-DZSMStandardStructureReport {
    "DeutschZ System Manager v0.3.9 - Standardstruktur" | Out-File -FilePath $StructureFile -Encoding UTF8
...
Datum: $(Get-Date)
Aktuelle Version: v0.3.9 NEONGREEN-ICONS
Startdatei: Start_DZSM_v0_3_9_NEONGREEN_ICONS.bat
...
function Write-DZSMPDriveWorkDriveNotes {
    "DeutschZ System Manager v0.3.9 - P-Root / DayZ Tools WorkDrive Notes" | Out-File -FilePath $WorkDriveNotesFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.9:" | Out-File -FilePath $WorkDriveNotesFile -Append -Encoding UTF8
...
function Invoke-DZSMAutoBackup {
    "DeutschZ System Manager v0.3.9 - SAFE AUTO BACKUP" | Out-File -FilePath $AutoBackupLogFile -Encoding UTF8
...
function Invoke-DZSMGitHubExport {
    "DeutschZ System Manager v0.3.9 - GitHub Export" | Out-File -FilePath $GitHubExportLogFile -Encoding UTF8
...
function Write-DZSMGitHubSafetyDocuments {
    "DeutschZ System Manager v0.3.9 - GitHub Safety Documentation" | Out-File -FilePath $SafetyDocsLogFile -Encoding UTF8
...
Start_DZSM_v0_3_9_NEONGREEN_ICONS.bat
...
function Write-DZSMLMStudioPolicy {
    "DeutschZ System Manager v0.3.9 - LM Studio / Modell Policy" | Out-File -FilePath $LMStudioPolicyFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.9:" | Out-File -FilePath $LMStudioPolicyFile -Append -Encoding UTF8
...
function Update-DZSMDesktopShortcuts {
    ...
    "DeutschZ System Manager v0.3.9 - Desktop-Verknuepfungen" | Out-File -FilePath $ShortcutLogFile -Encoding UTF8
    ...
    "v0.3.9: Dark/Neon-Green Icons, kein Rot, keine PS1-Desktop-Verknuepfung im Normalmodus." | Out-File -FilePath $ShortcutLogFile -Append -Encoding UTF8
    ...
    $currentBat = Join-Path $PSScriptRoot "Start_DZSM_v0_3_9_NEONGREEN_ICONS.bat"
    ...
    # Nur diese Auto-Linknamen duerfen entfernt/ersetzt werden.
    # Benutzerlinks bleiben erhalten.
...
function Update-DZSMBugReportWorkspace {
    "DeutschZ System Manager v0.3.9 - BugReport Arbeitsordner" | Out-File -FilePath $BugReportLogFile -Encoding UTF8
...
|---|---|---|---|---|---|
| $(Get-Date -Format "yyyy-MM-dd") | v0.3.9 | Desktop-Verknuepfung wurde zu breit geloescht | Wildcard-Loeschregel fuer DZSM-Links war zu aggressiv | Nur exakt bekannte Auto-Linknamen ersetzen; benutzerdefinierte Links schuetzen | behoben |
...
Datum: $(Get-Date)
Version: v0.3.9 NEONGREEN-ICONS
PC: $env:COMPUTERNAME
Benutzer: $env:USERNAME
...
function Update-DZSMUploadPackage {
    "DeutschZ System Manager v0.3.9 - Upload-Paket fuer ChatGPT" | Out-File -FilePath $UploadPackageLogFile -Encoding UTF8
...
# START
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.9 - DayZ Tools / P-Drive Mount Log" | Out-File -FilePath $MountLogFile -Encoding UTF8
...
# HAUPTREPORT
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.9 NEONGREEN-ICONS - Inventurbericht" | Out-File -FilePath $ReportFile -Encoding UTF8
...
# Backup Plan
"DeutschZ System Manager v0.3.9 - Backup Plan" | Out-File -FilePath $BackupPlanFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.9 - DeutschZ Structure Check" | Out-File -FilePath $DeutschZFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.9 - Cleanup Risk Check FAST" | Out-File -FilePath $CleanupFile -Encoding UTF8
...
# Migration check
"DeutschZ System Manager v0.3.9 - Windows SSD Migration Check" | Out-File -FilePath $MigrationFile -Encoding UTF8
...
"v0.3.9 fertig." | Out-File -FilePath $ReportFile -Append -Encoding UTF8

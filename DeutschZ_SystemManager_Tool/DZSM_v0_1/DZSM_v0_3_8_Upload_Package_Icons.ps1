...
# DeutschZ System Manager v0.3.8 UPLOAD-PACKAGE-ICONS
...
$allReportFiles = @(
    ...
    $SafetyDocsLogFile,$WorkDriveNotesFile,$LMStudioPolicyFile,$ShortcutLogFile,$BugReportLogFile,$UploadPackageLogFile,$NextFile
)
...
function Invoke-DZSMSelfCleanup {
    "DeutschZ System Manager v0.3.8 - Selbstbereinigung alter Versionen" | Out-File -FilePath $SelfCleanupFile -Encoding UTF8
    ...
    "v0.3.8 Fix: Erfasst jetzt auch alte BAT/PS1/README/Config/ZIP-Dateien im Arbeitsordner." | Out-File -FilePath $SelfCleanupFile -Append -Encoding UTF8
    ...
    $currentBatName = "Start_DZSM_v0_3_8_UPLOAD_PACKAGE_ICONS.bat"
    $currentPs1Name = "DZSM_v0_3_8_Upload_Package_Icons.ps1"
    $currentKeepNames = @(
        $currentBatName,
        $currentPs1Name,
        "README_START.txt",
...
function Write-DZSMStandardStructureReport {
    "DeutschZ System Manager v0.3.8 - Standardstruktur" | Out-File -FilePath $StructureFile -Encoding UTF8
...
Datum: $(Get-Date)
Aktuelle Version: v0.3.8 UPLOAD-PACKAGE-ICONS
Startdatei: Start_DZSM_v0_3_8_UPLOAD_PACKAGE_ICONS.bat
...
function Write-DZSMPDriveWorkDriveNotes {
    "DeutschZ System Manager v0.3.8 - P-Root / DayZ Tools WorkDrive Notes" | Out-File -FilePath $WorkDriveNotesFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.8:" | Out-File -FilePath $WorkDriveNotesFile -Append -Encoding UTF8
...
function Invoke-DZSMAutoBackup {
    "DeutschZ System Manager v0.3.8 - SAFE AUTO BACKUP" | Out-File -FilePath $AutoBackupLogFile -Encoding UTF8
...
function Invoke-DZSMGitHubExport {
    "DeutschZ System Manager v0.3.8 - GitHub Export" | Out-File -FilePath $GitHubExportLogFile -Encoding UTF8
...
function Write-DZSMGitHubSafetyDocuments {
    "DeutschZ System Manager v0.3.8 - GitHub Safety Documentation" | Out-File -FilePath $SafetyDocsLogFile -Encoding UTF8
...
Start_DZSM_v0_3_8_UPLOAD_PACKAGE_ICONS.bat
...
function Write-DZSMLMStudioPolicy {
    "DeutschZ System Manager v0.3.8 - LM Studio / Modell Policy" | Out-File -FilePath $LMStudioPolicyFile -Encoding UTF8
    ...
    "Entscheidung ab v0.3.8:" | Out-File -FilePath $LMStudioPolicyFile -Append -Encoding UTF8
...
function Update-DZSMDesktopShortcuts {
    ...
    "DeutschZ System Manager v0.3.8 - Desktop-Verknuepfungen" | Out-File -FilePath $ShortcutLogFile -Encoding UTF8
    ...
    "Es werden nur exakt bekannte DZSM-Auto-Verknuepfungen ersetzt." | Out-File -FilePath $ShortcutLogFile -Append -Encoding UTF8
    "v0.3.8: Verknuepfungen bekommen eigene DeutschZ/DZSM-Icons." | Out-File -FilePath $ShortcutLogFile -Append -Encoding UTF8
    ...
    $currentBat = Join-Path $PSScriptRoot "Start_DZSM_v0_3_8_UPLOAD_PACKAGE_ICONS.bat"
    $currentPs1 = Join-Path $PSScriptRoot "DZSM_v0_3_8_Upload_Package_Icons.ps1"

    $iconStart = Join-Path $PSScriptRoot "icons\DZSM_Start.ico"
    $iconScript = Join-Path $PSScriptRoot "icons\DZSM_Script.ico"
    $iconUpload = Join-Path $PSScriptRoot "icons\DZSM_Upload.ico"
    $iconReports = Join-Path $PSScriptRoot "icons\DZSM_Reports.ico"

    # Nur diese von DZSM automatisch erzeugten Linknamen duerfen entfernt/ersetzt werden.
    # KEIN Wildcard-Loeschen.
    # Die Benutzer-Verknuepfung DeutschZ_System_Manager - Verknuepfung.lnk wird NICHT angefasst.
    ...
    try {
        ...
        if (Test-PathFast $currentPs1) {
            ...
            if (Test-PathFast $iconScript) { $ps1Shortcut.IconLocation = $iconScript }
            $ps1Shortcut.Save()
        ...
        if (Test-PathFast $UploadPackageRoot) {
            ...
            $uploadShortcut.Save()
            "OK Upload-Reports-Verknuepfung erstellt: DeutschZ System Manager - Upload Reports.lnk -> $UploadPackageRoot" | Out-File -FilePath $ShortcutLogFile -Append -Encoding UTF8
        }
        ...
        if (Test-PathFast $ReportsRoot) {
            ...
            "OK Reports-Verknuepfung erstellt: DeutschZ System Manager - Reports.lnk -> $ReportsRoot" | Out-File -FilePath $ShortcutLogFile -Append -Encoding UTF8
        }
    } catch {
...
function Update-DZSMBugReportWorkspace {
    "DeutschZ System Manager v0.3.8 - BugReport Arbeitsordner" | Out-File -FilePath $BugReportLogFile -Encoding UTF8
...
|---|---|---|---|---|---|
| $(Get-Date -Format "yyyy-MM-dd") | v0.3.8 | Desktop-Verknuepfung wurde zu breit geloescht | Wildcard-Loeschregel fuer DZSM-Links war zu aggressiv | Nur exakt bekannte Auto-Linknamen ersetzen; benutzerdefinierte Links schuetzen | behoben |
...
Datum: $(Get-Date)
Version: v0.3.8 UPLOAD-PACKAGE-ICONS
PC: $env:COMPUTERNAME
Benutzer: $env:USERNAME
...
function Update-DZSMUploadPackage {
    "DeutschZ System Manager v0.3.8 - Upload-Paket fuer ChatGPT" | Out-File -FilePath $UploadPackageLogFile -Encoding UTF8
...
# START
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.8 - DayZ Tools / P-Drive Mount Log" | Out-File -FilePath $MountLogFile -Encoding UTF8
...
# HAUPTREPORT
# ------------------------------------------------------------
"DeutschZ System Manager v0.3.8 UPLOAD-PACKAGE-ICONS - Inventurbericht" | Out-File -FilePath $ReportFile -Encoding UTF8
...
# Backup Plan
"DeutschZ System Manager v0.3.8 - Backup Plan" | Out-File -FilePath $BackupPlanFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.8 - DeutschZ Structure Check" | Out-File -FilePath $DeutschZFile -Encoding UTF8
...
"DeutschZ System Manager v0.3.8 - Cleanup Risk Check FAST" | Out-File -FilePath $CleanupFile -Encoding UTF8
...
# Migration check
"DeutschZ System Manager v0.3.8 - Windows SSD Migration Check" | Out-File -FilePath $MigrationFile -Encoding UTF8
...
5. 22_P_ROOT_WORKDRIVE_NOTES.txt`r`n6. 23_LMSTUDIO_MODEL_POLICY.txt`r`n7. 24_DESKTOP_SHORTCUTS_LOG.txt`r`n8. 25_BUGREPORT_WORKSPACE_LOG.txt`r`n9. 26_UPLOAD_PACKAGE_LOG.txt`r`n`r`nOder einfacher: Den Ordner _UPLOAD_FUER_CHATGPT hochladen.
6. 11_DEUTSCHZ_STRUCTURE_CHECK.txt
"@ | Out-File -FilePath $NextFile -Encoding UTF8

Write-Section "ERGEBNIS"
"v0.3.8 fertig." | Out-File -FilePath $ReportFile -Append -Encoding UTF8

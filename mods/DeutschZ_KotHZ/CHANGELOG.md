...
- KotHZ custom runtime flagpole replaced by safe vanilla beacon/flag fallback for test builds to avoid native crash suspicion.
- Music remains disabled during safe-boot tests.
- Debug test zombies spawn near the KOTH beacon on event start.

...
class DeutschZKotHZConfig
{
    ...
    {
        ConfigInfo = "DeutschZ_KotHZ V0.9.3 normal online-test settings: 35-55 min event rotation, 25m radius, 9-12 min capture, 3 AI first contact, infected waves, boss and 500-slot reward crate.";
        EditHint = "V0.9.3 NORMAL: event rotation 35-55 minutes. All zones normalized to 25m capture radius, 9-12 minute capture time, Expansion markers, HUD/statusbar, first 3 AI guards, infected pressure waves, 7500 HP Mummy boss and 500-slot reward crate.";
        ...
        MinStartDelayMinutes = 35;
        MaxStartDelayMinutes = 55;
        MinPlayersToStart = 1;
        AnnounceEvent = 1;
        DebugMode = 0;
        EnableHUD = 1;
        ...
        nwaf.ZombieWaveCount = 5;
        nwaf.ZombiesPerWave = 6;
        nwaf.MaxTotalZombies = 30;
        ...
        nwaf.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        tisy.ZombieWaveCount = 5;
        tisy.ZombiesPerWave = 6;
        tisy.MaxTotalZombies = 30;
        ...
        tisy.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        lopa.ZombieWaveCount = 5;
        lopa.ZombiesPerWave = 6;
        lopa.MaxTotalZombies = 30;
        ...
        lopa.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        yrap.ZombieWaveCount = 5;
        yrap.ZombiesPerWave = 6;
        yrap.MaxTotalZombies = 30;
        ...
        yrap.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        zeleno.ZombieWaveCount = 5;
        zeleno.ZombiesPerWave = 6;
        zeleno.MaxTotalZombies = 30;
        ...
        zeleno.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        topolniki.CaptureTimeSeconds = 600;
        ...
        topolniki.ZombieWaveCount = 5;
        topolniki.ZombiesPerWave = 6;
        topolniki.MaxTotalZombies = 30;
        ...
        topolniki.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";
        ...
        berenzinho.CaptureTimeSeconds = 600;
        ...
        berenzinho.ZombieWaveCount = 5;
        berenzinho.ZombiesPerWave = 6;
        berenzinho.MaxTotalZombies = 30;
        ...
        berenzinho.WavePoolName = "DeutschZ_Normal_3AI_30Zombies";

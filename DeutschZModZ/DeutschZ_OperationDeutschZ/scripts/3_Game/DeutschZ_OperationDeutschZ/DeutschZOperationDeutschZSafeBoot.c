class DeutschZOperationDeutschZConstants
{
    ...
    static const string CONFIG_PATH = "$profile:DeutschZ/OperationDeutschZ/Config/OperationDeutschZConfig.json";
    static const string LEGACY_CONFIG_PATH = "$profile:DeutschZ/OperationDeutschZ/OperationDeutschZConfig.json";
...
class DeutschZOperationDeutschZSafeBoot
{
    ...
    static void LoadConfig()
    {
        ...
        {
            if (FileExist(DeutschZOperationDeutschZConstants.LEGACY_CONFIG_PATH))
            {
                JsonFileLoader<DeutschZOperationDeutschZConfig>.JsonLoadFile(DeutschZOperationDeutschZConstants.LEGACY_CONFIG_PATH, s_Config);
                Print(DeutschZOperationDeutschZConstants.PREFIX + " Legacy config imported");
            }
            JsonFileLoader<DeutschZOperationDeutschZConfig>.JsonSaveFile(DeutschZOperationDeutschZConstants.CONFIG_PATH, s_Config);
            Print(DeutschZOperationDeutschZConstants.PREFIX + " Config created/migrated");
        }
